...
class AccountModel(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="The creation time of the account")
    updated_at: Optional[datetime] = Field(None, description="The last update time of the account")
...
class DepartmentModel(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="The creation time of the department")
    updated_at: Optional[datetime] = Field(None, description="The last update time of the department")
...
class ProductModel(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="The creation time of the product")
    updated_at: Optional[datetime] = Field(None, description="The last update time of the product")
...
class PeopleModel(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="The creation time of the person")
    updated_at: Optional[datetime] = Field(None, description="The last update time of the person")
